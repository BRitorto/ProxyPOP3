#ifndef MIME_CHARACTERS_H
#define MIME_CHARACTERS_H

/**
 * mimeCharacters.c -- caracterización de caracteres RFC822/y lo relacionados a MIME
 *
 ...
 */
typedef enum mimeCharactersClass {
 ...
 */
const unsigned * initializeCharactersClass(void);
